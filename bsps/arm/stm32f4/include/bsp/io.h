...
#define STM32F4_PIN_I2C3_SCL_PA8  STM32F4_PIN_I2C(0, 8, STM32F4_GPIO_AF_I2C3)
#define STM32F4_PIN_I2C1_SCL_PB6  STM32F4_PIN_I2C(1, 6, STM32F4_GPIO_AF_I2C1)
#define STM32F4_PIN_I2C1_SDA_PB7  STM32F4_PIN_I2C(1, 7, STM32F4_GPIO_AF_I2C1)
#define STM32F4_PIN_I2C1_SCL_PB8  STM32F4_PIN_I2C(1, 8, STM32F4_GPIO_AF_I2C1)
#define STM32F4_PIN_I2C1_SDA_PB9  STM32F4_PIN_I2C(1, 9, STM32F4_GPIO_AF_I2C1)
#define STM32F4_PIN_I2C2_SCL_PB10 STM32F4_PIN_I2C(1, 10, STM32F4_GPIO_AF_I2C2)
#define STM32F4_PIN_I2C2_SDA_PB11 STM32F4_PIN_I2C(1, 11, STM32F4_GPIO_AF_I2C2)
#define STM32F4_PIN_I2C3_SDA_PC9  STM32F4_PIN_I2C(2, 9, STM32F4_GPIO_AF_I2C3)
#define STM32F4_PIN_I2C2_SDA_PF0  STM32F4_PIN_I2C(5, 0, STM32F4_GPIO_AF_I2C2)
#define STM32F4_PIN_I2C2_SCL_PF1  STM32F4_PIN_I2C(5, 1, STM32F4_GPIO_AF_I2C2)
#define STM32F4_PIN_I2C2_SCL_PH4  STM32F4_PIN_I2C(7, 4, STM32F4_GPIO_AF_I2C2)
#define STM32F4_PIN_I2C2_SDA_PH5  STM32F4_PIN_I2C(7, 5, STM32F4_GPIO_AF_I2C2)
#define STM32F4_PIN_I2C3_SCL_PH7  STM32F4_PIN_I2C(7, 7, STM32F4_GPIO_AF_I2C3)
#define STM32F4_PIN_I2C3_SDA_PH8  STM32F4_PIN_I2C(7, 8, STM32F4_GPIO_AF_I2C3)


#define STM32F4_PIN_SPI(port, idx, altfunc) \
  { \
    { \
      .pin_first = STM32F4_GPIO_PIN(port, idx), \
      .pin_last = STM32F4_GPIO_PIN(port, idx), \
...
#define STM32F4_PIN_SPI1_NSS_PA4   STM32F4_PIN_SPI(0, 4, STM32F4_GPIO_AF_SPI1)
#define STM32F4_PIN_SPI3_NSS_PA4   STM32F4_PIN_SPI(0, 4, STM32F4_GPIO_AF_SPI3)

#define STM32F4_PIN_SPI1_SCK_PA5   STM32F4_PIN_SPI(0, 5, STM32F4_GPIO_AF_SPI1)
#define STM32F4_PIN_SPI1_MISO_PA6  STM32F4_PIN_SPI(0, 6, STM32F4_GPIO_AF_SPI1)
#define STM32F4_PIN_SPI1_MOSI_PA7  STM32F4_PIN_SPI(0, 7, STM32F4_GPIO_AF_SPI1)

#define STM32F4_PIN_SPI1_NSS_PA15  STM32F4_PIN_SPI(0, 15, STM32F4_GPIO_AF_SPI1)
#define STM32F4_PIN_SPI3_NSS_PA15  STM32F4_PIN_SPI(0, 15, STM32F4_GPIO_AF_SPI3)

#define STM32F4_PIN_SPI1_SCK_PB3   STM32F4_PIN_SPI(1, 3, STM32F4_GPIO_AF_SPI1)
#define STM32F4_PIN_SPI3_SCK_PB3   STM32F4_PIN_SPI(1, 3, STM32F4_GPIO_AF_SPI3)
#define STM32F4_PIN_SPI1_MISO_PB4  STM32F4_PIN_SPI(1, 4, STM32F4_GPIO_AF_SPI1)
#define STM32F4_PIN_SPI3_MISO_PB4  STM32F4_PIN_SPI(1, 4, STM32F4_GPIO_AF_SPI3)
#define STM32F4_PIN_SPI1_MOSI_PB5  STM32F4_PIN_SPI(1, 5, STM32F4_GPIO_AF_SPI1)
#define STM32F4_PIN_SPI3_MOSI_PB5  STM32F4_PIN_SPI(1, 5, STM32F4_GPIO_AF_SPI3)

#define STM32F4_PIN_SPI2_NSS_PB9   STM32F4_PIN_SPI(1, 9, STM32F4_GPIO_AF_SPI2)
#define STM32F4_PIN_SPI2_SCK_PB10  STM32F4_PIN_SPI(1, 10, STM32F4_GPIO_AF_SPI2)

#define STM32F4_PIN_SPI2_NSS_PB12  STM32F4_PIN_SPI(1, 12, STM32F4_GPIO_AF_SPI2)
#define STM32F4_PIN_SPI2_SCK_PB13  STM32F4_PIN_SPI(1, 13, STM32F4_GPIO_AF_SPI2)
#define STM32F4_PIN_SPI2_MISO_PB14 STM32F4_PIN_SPI(1, 14, STM32F4_GPIO_AF_SPI2)
#define STM32F4_PIN_SPI2_MOSI_PB15 STM32F4_PIN_SPI(1, 15, STM32F4_GPIO_AF_SPI2)

#define STM32F4_PIN_SPI2_MISO_PC2  STM32F4_PIN_SPI(2, 2, STM32F4_GPIO_AF_SPI2)
#define STM32F4_PIN_SPI2_MOSI_PC3  STM32F4_PIN_SPI(2, 3, STM32F4_GPIO_AF_SPI2)

#define STM32F4_PIN_SPI3_SCK_PC10  STM32F4_PIN_SPI(2, 10, STM32F4_GPIO_AF_SPI3)
#define STM32F4_PIN_SPI3_MISO_PC11 STM32F4_PIN_SPI(2, 11, STM32F4_GPIO_AF_SPI3)
#define STM32F4_PIN_SPI3_MOSI_PC12 STM32F4_PIN_SPI(2, 12, STM32F4_GPIO_AF_SPI3)

#define STM32F4_PIN_SPI2_NSS_PI0   STM32F4_PIN_SPI(8, 0, STM32F4_GPIO_AF_SPI2)
#define STM32F4_PIN_SPI2_SCK_PI1   STM32F4_PIN_SPI(8, 1, STM32F4_GPIO_AF_SPI2)
#define STM32F4_PIN_SPI2_MISO_PI2  STM32F4_PIN_SPI(8, 2, STM32F4_GPIO_AF_SPI2)
#define STM32F4_PIN_SPI2_MOSI_PI3  STM32F4_PIN_SPI(8, 3, STM32F4_GPIO_AF_SPI2)


#define STM32F4_PIN_ETH(port, idx) \
  { \
    { \
      .pin_first = STM32F4_GPIO_PIN(port, idx), \
      .pin_last = STM32F4_GPIO_PIN(port, idx), \
      ...
      .ospeed = STM32F4_GPIO_OSPEED_25_MHZ, \
      .pupd = STM32F4_GPIO_NO_PULL, \
      .af = STM32F4_GPIO_AF_ETH \
    } \
  }

#define STM32F4_PIN_ETH_MDIO_PA2 STM32F4_PIN_ETH(0, 2)
#define STM32F4_PIN_ETH_MDC_PC1  STM32F4_PIN_ETH(2, 1)

#endif /* STM32F4_FAMILY_F2XX */
