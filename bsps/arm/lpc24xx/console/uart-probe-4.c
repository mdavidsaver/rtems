...
bool lpc24xx_uart_probe_4(rtems_termios_device_context *context)
{
  static const lpc24xx_pin_range pins [] = {
    LPC24XX_PIN_UART_4_TXD_P5_4,
    LPC24XX_PIN_UART_4_RXD_P5_3,
    LPC24XX_PIN_TERMINAL
  };

  lpc24xx_module_enable(LPC24XX_MODULE_UART_4, LPC24XX_MODULE_PCLK_DEFAULT);
